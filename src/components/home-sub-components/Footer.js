    ...
    return(
        ...
        <div className="Footercomponent">
            ...
            <div className="news-letter">
                ...
                <p className="news-letter-para">Enjoy 15% off* your first order when you sign up to our newsletter</p>   
            ...
            <div className="footer-end">
                <div className="copyright-statement">© Jaroti. All Rights Reserved.</div>
